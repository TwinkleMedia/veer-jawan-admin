...
const uploadImageToR2 = async (file) => {
  ...
  if (file.size > MAX_IMAGE_SIZE) {
    throw new Error("Event image must be less than 5 MB.");
  }

  // 1. Ask backend for presigned R2 upload URL
  const uploadUrlResponse = await fetch(
    `${API}/api/events/upload-url`,
    {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  // 3. Return information required by MongoDB
  return {
    url: imageUrl,
    publicId: fileKey,
  };
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <h3 className="text-lg font-black text-[#1a2744]">
          {event.title}
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-xl">
            <span className="text-[#293C86]">
              <CalendarIcon />
            </span>
        ...
        {event.bookingLink && (
          <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-xl">
            <span className="text-[#293C86] mt-0.5">
              <LinkIcon />
            </span>
...
function EditModal({
  ...
  const handleImage = (e) => {
    ...
    if (file.size > MAX_IMAGE_SIZE) {
      setError(
        "Event image must be less than 5 MB."
      );
      return;
    }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (imageFile) {
        imageData =
          await uploadImageToR2(imageFile);
      }
      ...
      <div className="space-y-4">
        ...
        >
          <input
            ...
            onChange={(e) =>
              set("bookingLink", e.target.value)
            }
          />
        </Field>
        ...
        >
          <div
            className="relative rounded-xl overflow-hidden border-2 border-gray-200 group cursor-pointer"
            onClick={() =>
            ...
            {imagePreview ? (
              <>
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition flex items-center justify-center opacity-0 group-hover:opacity-100">
                  <span className="text-white text-xs font-bold bg-black/30 px-3 py-1.5 rounded-lg">
                    Click to Change
                  </span>
                </div>
                ...
                {imageFile && (
                  <div className="absolute top-2 right-2">
                    <span className="text-[9px] font-black uppercase text-white bg-[#FF671F] px-2 py-0.5 rounded">
                      New Image
                    </span>
                  </div>
                )}
        ...
        <div className="flex gap-3 pt-2">
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-4 py-3 rounded-xl border border-gray-200 text-sm font-bold text-gray-500 hover:bg-gray-50 transition disabled:opacity-50"
          >
            Cancel
          </button>
...
function CreateEventForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        `Event "${data.data.title}" published successfully!`
      );
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-[#1a2744] to-[#293C86] border-b-2 border-[#FF671F]">
        ...
        <p className="text-white/50 text-xs mt-0.5">
          Fill in all the details for the event below.
        </p>
      </div>
      ...
      >
        ...
        >
          <input
            type="text"
            className={inputCls}
            placeholder="e.g. Shaheed Samman Samaroh 2025"
            value={form.title}
            onChange={(e) =>
              set("title", e.target.value)
            }
          ...
          {imagePreview ? (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-bold text-gray-600 group-hover:text-[#293C86] transition">
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-[#1a2744] to-[#293C86] border-b-2 border-[#FF671F]">
        ...
        <p className="text-white/50 text-xs mt-0.5">
          {events.length} event
          {events.length !== 1 ? "s" : ""} in the database
        </p>
            ...
            <table className="w-full text-sm table-fixed">
              ...
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  ...
                  <th className="px-4 py-3 text-left text-[11px] font-bold tracking-wider uppercase text-gray-400 w-[28%]">
                    Event
                  </th>

                  <th className="px-4 py-3 text-left text-[11px] font-bold tracking-wider uppercase text-gray-400 w-[14%]">
                    Date
                  </th>

                  <th className="px-4 py-3 text-left text-[11px] font-bold tracking-wider uppercase text-gray-400 w-[10%]">
                    Time
                  </th>

                  <th className="px-4 py-3 text-left text-[11px] font-bold tracking-wider uppercase text-gray-400 w-[22%]">
                    Address
                  </th>

                  <th className="px-4 py-3 text-left text-[11px] font-bold tracking-wider uppercase text-gray-400 w-[12%]">
                    Booking
                  </th>
            ...
            {paginated.map((event) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-bold text-[#1a2744] text-sm truncate mb-1">
                    {event.title}
                  </p>
    ...
    <div className="min-h-screen bg-gray-50 pt-16 lg:pt-0 px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 sm:mb-6">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 pl-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm px-4 py-2.5 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-lg font-black text-[#1a2744] leading-none">
                {events.length}
              </p>
