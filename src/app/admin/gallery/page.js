...
function ViewModal({ gallery, onClose }) {
  ...
  const videos = gallery.media.filter(
    (m) => m.type === "video"
  );
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {gallery.media.length} file
              {gallery.media.length !== 1 ? "s" : ""}
              {" · "}
                ...
                {videos.map((vid, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-[10px] text-gray-400 px-3 py-1.5 truncate">
                        {vid.url}
                      </p>
...
function EditModal({
  ...
  const [newVideoLink, setNewVideoLink] =
    useState("");

  const [addVideoLinks, setAddVideoLinks] =
    useState([]);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/gallery/${gallery._id}`,
        {
          method: "PATCH",
          credentials: "include",
          headers: {
            ...
            <div>
                  ...
                  >
                    ...
                    {item.type === "image" ? (
                      ...
                      <div className="w-full h-full bg-gray-900 flex flex-col items-center justify-center text-white text-[9px] gap-1 px-1">
                        ...
                        <span className="truncate w-full text-center opacity-60">
                          {item.fileName}
                        </span>
              ...
              {mediaToDelete.size > 0 && (
                ...
                <p className="text-xs text-red-400 mt-2">
                  ...
                  {mediaToDelete.size} item
                  {mediaToDelete.size > 1
                    ? "s"
                    : ""}{" "}
                  marked for removal
              ...
              <div className="mt-2 space-y-1">
                ...
                {addVideoLinks.map(
                  (link, i) => (
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-3 py-1.5"
                    >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      ...
      <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl p-6 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">
          ...
          " and all its media will be permanently removed.
...
export default function GalleryPage() {
  ...
  const [videoLinks, setVideoLinks] =
    useState([]);

  const [videoLinkInput, setVideoLinkInput] =
    useState("");

  const [videoLinkError, setVideoLinkError] =
    useState("");
  ...
  const [sizeErrors, setSizeErrors] =
    useState([]);

  const [isDraggingImg, setIsDraggingImg] =
    useState(false);
  ...
  // Modals
  const [viewGallery, setViewGallery] =
    useState(null);

  const [editGallery, setEditGallery] =
    useState(null);

  const [deleteGallery, setDeleteGallery] =
    useState(null);
  ...
  const validateAndAddImages = (
    ...
    files.forEach((f) => {
      ...
      if (
        ...
        errors.push(
          `"${f.name}" exceeds ${MAX_IMAGE_SIZE_MB} MB limit.`
        );
  ...
  const uploadImageToR2 = async (
    ...
    // STEP 1
    // Ask backend for signed R2 URL

    const uploadUrlRes =
      await fetch(
        `${API_URL}/api/gallery/upload-url`,
        {
          method: "POST",
    ...
    if (!uploadUrlRes.ok) {
      ...
      throw new Error(
        uploadData.message ||
          "Failed to generate R2 upload URL."
      );
    ...
    if (!uploadUrl || !fileKey) {
      ...
      throw new Error(
        "Invalid R2 upload URL response."
      );
    ...
    if (!r2Response.ok) {
      ...
      throw new Error(
        `Failed to upload "${file.name}" to Cloudflare R2.`
      );
    ...
    // STEP 3
    // Return only metadata to Gallery API
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      // ───────────────────────────────────────
      // STEP 1
      // Upload every selected image directly
      // to Cloudflare R2
      // ───────────────────────────────────────
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-10">
      ...
      <div
        className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 text-white text-sm px-5 py-2.5 rounded-full shadow-lg transition-all duration-300 whitespace-nowrap ${
          toast.type === "error"
            ? "bg-red-600"
            : "bg-gray-900"
        } ${
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">
              Share your photos and video links in one place
            </p>
            ...
            >
              ...
              <div>
                ...
                <label className="flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-gray-400 mb-2">
                  ...
                  {images.length > 0 && (
                    ...
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 normal-case tracking-normal">
                  ...
                  <span className="ml-auto text-[10px] font-normal normal-case tracking-normal text-gray-400">

                    Max {MAX_IMAGE_SIZE_MB} MB per file
                      ...
                      (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute top-1 right-1 w-5 h-5 rounded-full bg-black/50 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center"
                          >
                            ×
                          </button>
              ...
              <div>
                ...
                <label className="flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-gray-400 mb-2">
                  ...
                  {videoLinks.length > 0 && (
                    ...
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-green-50 text-green-600 normal-case tracking-normal">
                ...
                <p className="text-xs text-gray-400 mb-2">
                  ...
                  Paste YouTube, Vimeo, or any direct video URL
                      ...
                      (link, i) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="text-green-400 hover:text-red-400 transition text-base leading-none flex-shrink-0"
                          >
                            ✕
                          </button>
              ...
              {mediaError && (
                ...
                <p className="text-xs text-red-400">
                  ...
                  Please add at least one image or video link
              ...
              <div className="divide-y divide-gray-50">
                ...
                {paginated.map((g) => {
                  ...
                  return (
                    ...
                    <div
                      key={g._id}
                      className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-4 items-center px-5 py-4 hover:bg-gray-50/60 transition"
                    >
